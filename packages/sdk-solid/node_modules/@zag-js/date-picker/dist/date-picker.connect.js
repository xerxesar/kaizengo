...
function connect(service, normalize) {
  ...
  const translations = (0, import_utils.mergeWithDefault)(import_date_picker2.defaultTranslations, prop("translations"));
  ...
  return {
    ...
    getViewTriggerProps(props = {}) {
      const { view = "day" } = props;
      const nextView = (0, import_date_picker2.getNextView)(view, prop("minView"), prop("maxView"));
    ...
    getInputProps(props = {}) {
      ...
      return normalize.input({
        ...
        onBeforeInput(event) {
          ...
          if (!(0, import_date_utils.isValidCharacter)(data, separator, locale)) {
            event.preventDefault();
          }
        },
        onClick(event) {
        ...
        onInput(event) {
          ...
          send({ type: "INPUT.CHANGE", value: (0, import_date_utils.ensureValidCharacters)(value, separator, locale), index });
        }
      });
    },
    getMonthSelectProps() {
