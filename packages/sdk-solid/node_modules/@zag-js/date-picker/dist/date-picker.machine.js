...
var machine = (0, import_core.createMachine)({
  props({ props }) {
    ...
    const defaultView = (0, import_date_picker.clampView)(props.defaultView || props.view || minView, minView, maxView);
    return {
      locale,
      numOfMonths,
      timeZone,
  ...
  implementations: {
    ...
    actions: {
      ...
      selectParsedDate({ context, event, prop }) {
        ...
        const adjustedValues = (0, import_date_picker.adjustStartAndEndDate)(values);
