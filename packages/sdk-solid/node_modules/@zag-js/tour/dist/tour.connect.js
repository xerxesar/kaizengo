...
function connect(service, normalize) {
  ...
  const placementSide = (0, import_step.isTooltipPlacement)(placement) ? (0, import_popper.getPlacementSide)(placement) : void 0;
  const targetRect = context.get("targetRect");
  const floatingOffset = context.get("floatingOffset");
  const tooltipPositioned = (0, import_step.isTooltipStep)(step) && floatingOffset != null;
  const popperStyles = (0, import_popper.getPlacementStyles)({
    strategy: "absolute",
    placement: tooltipPositioned && (0, import_step.isTooltipPlacement)(placement) ? placement : void 0
  });
  ...
  return {
    ...
    getSpotlightProps() {
      return normalize.element({
        ...
        style: {
          "--tour-layer": 1,
          "--spotlight-x": (0, import_utils.toPx)(targetRect.x),
          "--spotlight-y": (0, import_utils.toPx)(targetRect.y),
          "--spotlight-width": (0, import_utils.toPx)(targetRect.width),
          "--spotlight-height": (0, import_utils.toPx)(targetRect.height),
          position: "absolute",
    ...
    getPositionerProps() {
      return normalize.element({
        ...
        style: {
          "--tour-layer": 2,
          ...(0, import_step.isTooltipStep)(step) && {
            ...popperStyles.floating,
            ...floatingOffset && {
              "--x": (0, import_utils.toPx)(floatingOffset.x),
              "--y": (0, import_utils.toPx)(floatingOffset.y)
            },
