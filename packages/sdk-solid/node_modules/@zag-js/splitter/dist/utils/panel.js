...
function getPanelFlexBoxStyle({
  ...
  const minSizeCss = panel ? (0, import_size.toCssPanelSize)(panel.minSize) : void 0;
  const maxSize = panel ? (0, import_size.toCssPanelSize)(panel.maxSize) : void 0;
  const minSize = collapsed ? (0, import_size.toCssPanelSize)(panel?.collapsedSize ?? 0) : minSizeCss;
