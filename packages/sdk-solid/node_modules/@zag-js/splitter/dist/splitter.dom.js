...
var getPanelEls = (ctx) => (0, import_dom_query.queryAll)(getRootEl(ctx), `[data-part=panel]${(0, import_dom_query.getByOwnerId)(getRootId(ctx))}`);
...
var getResizeTriggerEls = (ctx) => {
  return (0, import_dom_query.queryAll)(getRootEl(ctx), `[role=separator]${(0, import_dom_query.getByOwnerId)(getRootId(ctx))}`);
};
