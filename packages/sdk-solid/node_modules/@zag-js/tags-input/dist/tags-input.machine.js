...
var import_tags_input = require("./tags-input.translations.js");
  ...
  implementations: {
    ...
    actions: {
      ...
      addTagFromPaste({ context, computed, prop, refs }) {
        (0, import_dom_query.raf)(() => {
          ...
          if (guard) {
            ...
            const nextValue = prop("allowDuplicates") ? value.concat(...sanitizedValues) : (0, import_utils.uniq)(value.concat(...sanitizedValues));
            context.set("value", nextValue);
            const prevLog = refs.get("log");
            refs.set("log", {
              prev: prevLog.current,
      ...
      announceLog({ refs, prop }) {
        ...
        const translations = (0, import_utils.mergeWithDefault)(import_tags_input.defaultTranslations, prop("translations"));
        const log = refs.get("log");
