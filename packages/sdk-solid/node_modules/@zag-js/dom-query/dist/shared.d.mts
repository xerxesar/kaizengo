...
declare const getByOwnerId: (id: string | undefined) => string;
declare const isOwnedBy: (el: Element | null | undefined, id: string | undefined) => boolean;
declare const sanitize: (str: string) => string;

export { MAX_Z_INDEX, ariaAttr, clamp, dataAttr, getByOwnerId, isObject, isOwnedBy, noop, pipe, sanitize, wrap };
