  ...
  implementations: {
    ...
    effects: {
      ...
      trackPanelStack({ context, scope }) {
        const unsub = import_floating_panel.panelStack.subscribe(() => {
          context.set("isTopmost", import_floating_panel.panelStack.isTopmost(scope.id));
          context.set("stackIndex", import_floating_panel.panelStack.indexOf(scope.id));
        });
        return () => {
    ...
    actions: {
      ...
      removeFromPanelStack({ prop }) {
        import_floating_panel.panelStack.remove(prop("id"));
      },
      invokeOnOpen({ prop }) {
