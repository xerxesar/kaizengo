import { HotkeyStoreOptions, HotkeyStoreState, CommandDefinition } from './types.js';

declare class HotkeyStore {
    private state;
    private target?;
    private defaultCommandOptions;
    private commandOptionOverrides;
    private sequenceTimeoutMs;
    ...
    private modifiersMatchPressed;
    private applyDefaultOptions;
    private updateParsedHotkeys;
    private refreshKeyupFlag;
    private detectConflicts;
    private getAttachedPhases;
    private updateListeners;
    private startListening;
    private stopListening;
    private getListenerPhases;
    private handleKeyUp;
    private handleBlur;
    private executeMatchingCommands;
    private handleSequence;
    private clearAllSequences;
    private resetSequence;
    private notifySubscribers;
}
declare function createHotkeyStore(options?: HotkeyStoreOptions): HotkeyStore;

export { HotkeyStore, createHotkeyStore };
