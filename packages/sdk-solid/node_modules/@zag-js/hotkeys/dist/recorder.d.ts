import { FormatHotkeyOptions } from './format.js';
import { HotkeyTarget } from './types.js';

interface RecordedHotkey {
    /**
...
declare class HotkeyRecorder {
    ...
    private buildRecordedHotkey;
    private finalize;
    private clearSequenceTimer;
}
declare function createHotkeyRecorder(options?: HotkeyRecorderOptions): HotkeyRecorder;

export { HotkeyRecorder, type HotkeyRecorderOptions, type HotkeyRecorderState, type RecordedHotkey, createHotkeyRecorder };
