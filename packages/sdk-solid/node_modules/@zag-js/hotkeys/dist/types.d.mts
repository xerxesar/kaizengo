type HotkeyTarget = Document | ShadowRoot | Element;
type HotkeyCommandTarget = HotkeyTarget | (() => HotkeyTarget | null);
...
interface SequenceStep extends KeyboardModifiers {
    key: string;
}
interface ParsedHotkey extends KeyboardModifiers {
    keys: string[];
...
type FormTagName = "input" | "textarea" | "select";
...
export type { CommandDefinition, ConflictBehavior, FormTagName, HotkeyAction, HotkeyCommand, HotkeyCommandTarget, HotkeyOptions, HotkeyStoreOptions, HotkeyStoreState, HotkeyTarget, KeyboardModifiers, ParsedHotkey, Platform, SequenceStep };
