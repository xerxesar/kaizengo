...
var FocusTrap = class {
  ...
  isPersistentElement(element, event) {
    ...
    return persistentElements.some((getEl) => {
      const el = getEl();
      return (0, import_dom_query.contains)(el, element) || el != null && composedPath?.includes(el);
    });
  }
  updateTabbableNodes() {
  ...
  containsElement(element) {
    return this.state.containers.some((container) => (0, import_dom_query.contains)(container, element));
  }
  ...
  isSafeToOverrideFocus() {
    const activeEl = (0, import_dom_query.getActiveElement)(this.doc);
