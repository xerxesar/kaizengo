...
var getTriggerEls = (scope) => (0, import_dom_query.queryAll)(scope.getRootNode(), `[data-scope="hover-card"][data-part="trigger"]${(0, import_dom_query.getByOwnerId)(scope.id)}`);
