...
declare class IncompleteDate {
    ...
    withHourCycle(nextHourCycle: HourCycle$1): IncompleteDate;
...
declare function getFormatterOptions(opts: FormatterOptions): Intl.DateTimeFormatOptions;
...
type PropsWithDefault = "selectionMode" | "locale" | "timeZone" | "granularity" | "shouldForceLeadingZeros" | "formatter" | "allSegments" | "format";
...
export { needsTimeGranularity as A, processSegments as B, resolveAllSegments as C, type DateInputApi as D, type EditableSegmentType as E, type FocusChangeDetails as F, type HiddenInputProps as H, type IntlTranslations as I, type LabelProps as L, type PlaceholderChangeDetails as P, type SegmentGroupProps as S, TYPE_MAPPING as T, type ValueChangeDetails as V, type DateSegment as a, type ElementIds as b, type FormatDateDetails as c, type HourCycle as d, type DateInputMachine as e, type DateInputProps as f, type SegmentProps as g, type SegmentState as h, type SegmentType as i, type Segments as j, type SegmentsProps as k, type SelectionMode as l, type DateInputService as m, type DateInputSchema as n, IncompleteDate as o, type HourCycle$1 as p, incompleteDateEqual as q, incompleteDateHash as r, initDisplayValues as s, resolvedHourCycle as t, toHourCycle as u, EDITABLE_SEGMENTS as v, type FormatterOptions as w, PAGE_STEP as x, getFormatterOptions as y, getSegmentLabel as z };
