  ...
  computed: {
    ...
    segments: (0, import_core.memo)(
      ...
      (_deps, { context, prop, computed }) => {
        ...
        const translations = (0, import_utils.mergeWithDefault)(import_placeholders.defaultTranslations, prop("translations"));
        ...
        return Array.from({ length: computed("groupCount") }, (_, i) => {
          ...
          return (0, import_segments.processSegments)({
            dateValue: (0, import_formatting.toFormatterDate)(displayDate, segmentFormatter),
            displayValue,
