...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Item
    ref={ref}
    className={cn(
      'relative flex cursor-pointer items-center px-4 py-2 text-sm text-[var(--kg-text)] outline-none data-[highlighted]:bg-[var(--kg-surface-hover)] data-[state=checked]:font-semibold data-[state=checked]:text-[var(--kg-primary)]',
      className,
    )}
    {...props}
  >
